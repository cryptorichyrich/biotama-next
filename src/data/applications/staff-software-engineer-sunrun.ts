...
export const application_staff_software_engineer_sunrun: Application = {
  slug: 'staff-software-engineer-sunrun',
  company: {
    name: 'Sunrun',
    website: "",
    logo: "",
  ...
  source: {
    url: 'https://www.themuse.com/jobs/sunrun/staff-software-engineer-51c2b5',
    platform: 'The Muse',
