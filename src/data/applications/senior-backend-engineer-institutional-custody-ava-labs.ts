...
export const applicationsenior_backend_engineer_institutional_custody_ava_labs: Application = {
  slug: 'senior-backend-engineer-institutional-custody-ava-labs',
  company: {
    name: 'Ava Labs',
    website: "",
    logo: "",
  ...
  position: {
    title: 'Senior Backend Engineer, Institutional Custody',
    department: "",
    type: 'full-time',
    remote: true,
  ...
  source: {
    url: 'https://www.themuse.com/jobs/avalabs/senior-backend-engineer-institutional-custody',
    platform: 'The Muse',
